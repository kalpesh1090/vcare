...
@section('content')
				...
				<div class="content">
                    ...
                    <div class="card-body">    
                                ...
                                <div class="stepwizard">
                                    <div class="stepwizard-row setup-panel">
                                        <div class="stepwizard-step">
                                            <a href="#step-1" type="button" class="btn btn-primary btn-circle  <?php if($step == "1"){ echo 'btn-primary';  } ?> " 
                                                <?php if($step == "1"){ ?>
                                             disabled="disabled"
                                            <?php } ?>
                                                 style="">1</a>
                                        ...
                                        <div class="stepwizard-step">
                                            <a href="#step-2" type="button"  class="btn btn-default btn-circle <?php if($step == "2"){ echo 'btn-primary';  } ?>" 
                                             <?php if($step == "2"){ ?>
                                             disabled="disabled"
                                            <?php } ?>
                                      ...
                                      <!--   <div class="stepwizard-step">
                                        ...
                                        <div class="stepwizard-step">
                                            <a href="#step-3" type="button" class="btn btn-default btn-circle <?php if($step == "3"){ echo 'btn-primary';  } ?> " 
                                                <?php if($step == "3"){ ?>
                                             disabled="disabled"
                                            <?php } ?>>3</a>
                                            <p>INCOME</p>
                                        ...
                                        <div class="stepwizard-step">
                                            <a href="#step-4" type="button" class="btn btn-default btn-circle <?php if($step == "4"){ echo 'btn-primary';  } ?>"
                                                <?php if($step == "4"){ ?>
                                             disabled="disabled"
                                            <?php } ?>
                                                >4</a>
                        ...
                        @csrf           
                            <div class="setup-content" id="step-1" style="display: <?php if($step == "1"){ echo 'block';  } ?>">
                            <input   type="hidden" id="id_3" name="id" value="{{$editData['id']}}" >
                      ...
                      <div class="setup-content" id="step-2" style="display: <?php if($step == "2"){ echo 'block';  } ?>">
                            <input type="hidden" id="id" class="insert_id" name="id" value="{{$editData['id']}}" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="resident_status_details" required class="form-control"  placeholder="Resident Status Details" value="{{$editData['resident_status_details']}}">
                                            <span  class="resident_status_details text-danger"></span>
                        ...
                        @csrf           
                            <div class="setup-content" id="step-3" style="display: <?php if($step == "3"){ echo 'block';  } ?>">
                                <input type="hidden"  id="id_1" name="id_1" value="{{$editData['id']}}">
                                <div class="row">
                        ...
                        @csrf           
                            <div class="setup-content" id="step-4" style="display: <?php if($step == "4"){ echo 'block';  } ?>">

                                <div class="documentList" id="documentList"></div>
                                <fieldset class="mb-3">
                                <input type="hidden" name="income_tax_returns_id" id="user_id" value="{{$editData['id']}}" required class="form-control">
                    ...
                    $.ajax({
                        ...
                        success: function (data)
                        {
                           ...
                           // history.pushState(null, '', 'create/'); 
                            ...
                            var pageUrl = '?id=' +data.form_id+'&step='+2;
                ...
                $(document).on('click','#second_form_button',function(e){
                    ...
                    $.ajax({
                        ...
                        success: function (data)
                        {
                            ...
                            var pageUrl = '?id=' +data.form_id+'&step='+3;
                            window.history.pushState('', '', pageUrl);
...
// alert("hi");
                    ...
                    $.ajax({
                        ...
                        success: function (data)
                        {
                            ...
                            var pageUrl = '?id=' +data.form_id+'&step='+4;
                            window.history.pushState('', '', pageUrl);
