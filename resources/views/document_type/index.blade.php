					...
					<div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
						<div class="d-flex">
							<div class="breadcrumb">
								...
								<span class="breadcrumb-item active">Document Type List
						...
						<div class="d-flex justify-content-center">
                            <a class="btn btn-info text-right pull-right float-right btn-xm"  href="{{url('document_type/get_create')}}" style="padding: 4px 10px;">Add</a>
						</div>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#return_tbl').DataTable({
            ...
            ajax: {
                type: 'GET',
                url: base_url + '/document_type/list',
            ...
            columns: [
                ...
                "render": function (data, type, row) {
                    var id = row.id;
                    var out = '';
                    out += '<a title="Edit" href="' + base_url + '/document_type/get_update/' + id + '" class="text-info "><i class="icon-pencil7"></i></a>&nbsp;';
                    out += '<a title="Delete" class="text-danger delete_btn"  href="' + base_url + '/document_type/delete/' + id + '"><i class="icon-trash"></i></a>';
                    out += '&nbsp;<a title="View" href="' + base_url + '/document_type/delete/' + id + '" class="text-info "><i class="icon-zoomin3"></i></a>&nbsp;';
