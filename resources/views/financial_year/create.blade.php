	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<span class="breadcrumb-item active">Financial Year Detail</span>
			</div>
				...
				<div class="form-group">
					<div class="row">
						<div class="col-lg-6">
							...
							<input type="text"  value="" class="form-control" name="year" placeholder="Financial Year">
  ...
  headers: {
    ...
    $(document).on('click', '#createBtn', function(e) {
      ...
      $.ajax({
        ...
        url: "{{ route('financial_year.post_create') }}",
