                    ...
                    <div class="stepwizard">
                        <div class="stepwizard-row setup-panel">
                            <div class="stepwizard-step">
                                <a href="#step-1" type="button" class="btn btn-primary btn-circle  <?php
                                if ($step == "1") {
                                    echo 'btn-primary';
                                }
                                ?> " 
                    ...
                    <div class="row">
                        ...
                        ?>  >
                            <div class="form-group">
                                ...
                                <input type="text" name="relationship_other" class="form-control" required placeholder="Other relationship" value="{{$editData['relationship_other']}}">
                                <span  class="relationship_other text-danger"></span>
        ...
        $(document).on('click', '#first_form_button', function (e) {
            ...
            $.ajax({
                ...
                error: function (error) {
                    ...
                    var notification = alertify.notify('Please check validation.', 'error', 6);
                ...
                success: function (data)
                {
                    ...
                    var notification = alertify.notify('Personal information added successfully.', 'success', 6);
                }
            });
        });
        $(document).on('click', '#second_form_button', function (e) {
            ...
            $.ajax({
                ...
                success: function (data)
                {
                    ...
                    //var notification = alertify.notify('Address details updated.', 'success', 6);                        
                    window.location.replace('{{ asset("/members")}}');
                }
            });
        });
