	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<span class="breadcrumb-item active">Subscription Detail</span>
			</div>
	...
	<div class="card">
      ...
      <meta name="csrf-token" content="{{ csrf_token() }}">
				...
				<div class="form-group">
					<div class="row">
						<div class="col-lg-6">
							...
							<input type="text"  value="" class="form-control" name="name" placeholder="Subscription Name">
                ...
                <label>Amount<span class="text-danger">*</span></label>
							<input type="number"  value="" class="form-control" name="amount" placeholder="Amount">
