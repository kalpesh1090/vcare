            ...
            <form id="promo_form" action="{{route('plan.promo')}}" method="post">
               ...
               <div class="form-group row">
                <div class="col-md-5">
                    ...
                    <input disabled type="text" name="promo_Code" class="form-control" required placeholder="Promo code" value="{{$code_master->code_name}}">
                </div>
                <div class="col-md-2">
                    <button type="submit" disabled class="promo_submit btn btn-success">Applied</button>    
                </div>   
               </div>
        ...
        <table class="table">
            ...
            <form action="{{route('payment')}}" method="post">
                ...
                <tr>
                    ...
                    <td><del style="color:brown;">{{$plan->standard_fee }}</del><span style="margin-left: 15px;">{{$plan->amount}}</span></td>
                </tr>
                @php($i++)
                @endforeach
                <tr>
